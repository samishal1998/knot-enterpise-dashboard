...
export const MyMenu = () => (
    <Menu >
        <Box className={"show-open-hide-closed"} sx={{height:"100%",alignItems:"center",justifyContent:"center",display:"flex",flexDirection:"column", p:1,mb:5}} >

            <img src={AppIcon} style={{height:"80%",width:"100%", marginRight:5,marginLeft:5,borderRadius:"100%"}}/>
            <Typography
        ...
        <Divider/>
        <Menu.Item to={''} primaryText="Logout" leftIcon={<Logout/>} onClick={(event) => {
