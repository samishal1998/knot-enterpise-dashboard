...
export const ManageMetafields: BasePageType = () => {
...
ManageMetafields.route = '/dashboard/metafields/manage';
ManageMetafields.generatePath = generatePath(ManageMetafields.route);
export default ManageMetafields;
